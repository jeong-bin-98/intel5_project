...
사용법:
    python src/detection/tests/test_detect.py                          # D435 카메라 실시간 탐지
    python src/detection/tests/test_detect.py --image test.png         # 단일 이미지 탐지
    python src/detection/tests/test_detect.py --dir new_images         # 폴더 내 전체 이미지 탐지
