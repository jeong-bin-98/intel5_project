...
from config.paths import RUNS_DIR, NEW_IMAGES_DIR, DATASET_IMAGES_TRAIN, DATASET_LABELS_TRAIN
...
# ===== 설정 =====
MODEL_PATH = os.path.join(RUNS_DIR, "detect", "socket_detector2", "weights", "best.pt")  # Step 4 학습 결과
CONFIDENCE_THRESHOLD = 0.10                 # 이 이상만 자동 라벨로 채택
OUTPUT_IMAGE_DIR = DATASET_IMAGES_TRAIN     # 기존 학습 데이터에 합침
